     ...
     @endif
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">ویرایش دسته بندی شماره {{ $slider->id }}</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{ route('slider.update',['slider'=>$slider->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
            {{ method_field('PATCH') }}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputEmail3" name="title" value="{{ $slider->title }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" name="url" value="{{ $slider->url }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                  <img src="/{{ $slider->image }}" style="width:400px;max-height:100px;height: auto;float: right;" alt="">
