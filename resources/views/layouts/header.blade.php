<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
       ...
       <a href="https://github.com/hosseinizadeh/AdminLTE_Persian" class="btn hidden-xs" style="margin:6px 100px;padding:9px 50px;background-color:#d61577;border-color:#ad0b5d;font-weight:bold;color:#FFF">دانلود  </a>
       <!-- End Delete-->
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ auth()->user()->image }}" class="user-image" alt="عکس ادمین">
